					...
					for(var tt = 0; tt < data.data.dicParamList.length; tt++) {
                        if (data.data.dicParamList[tt].paramName == "comqq") {
                            ...
                            for (var i = 0; i < strs.length; i++) {
                                ...
                                QqHtml += "<li><a target='_blank' href='http://wpa.qq.com/msgrd?v=3&uin=" + subStrs[0] + "&site=qq&menu=yes'><img border='0' src='" + realPath + "/images/side_icon01.png' alt='点击这里给我发消息' title='点击这里给我发消息'/>" + subStrs[1] + "</a> </li>";
                                if (i >= 3) {
                                    break;
                                }
                            }
